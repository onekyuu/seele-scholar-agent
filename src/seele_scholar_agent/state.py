...
class AgentState(TypedDict):
    ...
    existing_content: NotRequired[Any]
    draft_integration: NotRequired[Any]
    draft_diagnostics: NotRequired[dict[str, Any]]
    draft_gate_diagnostics: NotRequired[dict[str, Any]]
